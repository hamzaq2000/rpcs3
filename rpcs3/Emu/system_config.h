...
struct cfg_root : cfg::node
{
	...
	struct node_video : cfg::node
	{
		...
		cfg::_bool force_framebuffer_feedback_copies{ this, "Force Framebuffer Feedback Copies", false, true };

		bool avoid_framebuffer_feedback_loops() const
		{
			return strict_rendering_mode || force_framebuffer_feedback_copies;
		}
